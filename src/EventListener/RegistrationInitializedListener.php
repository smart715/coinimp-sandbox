 ...
 * and redirect them to dashboard instead.
 */
class RegistrationInitializedListener
{
    ...
    {
        $this->redirectToDashboardIfAuthenticated($event);
    }

    private function redirectToDashboardIfAuthenticated(GetResponseUserEvent $event): void
    {
